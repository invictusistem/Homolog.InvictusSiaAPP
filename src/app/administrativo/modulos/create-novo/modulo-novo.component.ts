...
@Component({
  ...
  styleUrls: ['./modulo-novo.component.scss']
})
export class ModuloNovoComponent extends BaseComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ModuloNovoComponent>,
